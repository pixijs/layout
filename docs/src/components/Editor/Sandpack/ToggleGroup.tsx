    ...
    return (
        ...
        >
            <button
                ...
                style={{
                    backgroundColor: selected === 'editor' ? selectedBackgroundColor : 'transparent',
                    ...buttonStyle,
                }}
            >
                Editor
            ...
            <button
                ...
                style={{
                    backgroundColor: selected === 'preview' ? selectedBackgroundColor : 'transparent',
                    ...buttonStyle,
                }}
            >
                Preview
            ...
            <button
                ...
                style={{
                    backgroundColor: selected === 'both' ? selectedBackgroundColor : 'transparent',
                    ...buttonStyle,
                }}
            >
                Both
